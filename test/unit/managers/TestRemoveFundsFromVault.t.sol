...
contract TestRemoveFundsFromVault is VaultFundManagerBase {
    ...
    function test_RemoveFundsFromVault_Success() public {
        ...
        // Check balances
        assertEq(usdc.balanceOf(address(vault)), initialVaultBalance - TEST_TRANSFER_AMOUNT);
        assertEq(usdc.balanceOf(recipient1), initialRecipientBalance + TEST_TRANSFER_AMOUNT);
    ...
    function test_RemoveFundsFromVault_WithMaximumAmount() public {
        ...
        assertEq(usdc.balanceOf(recipient1), vaultBalance);
