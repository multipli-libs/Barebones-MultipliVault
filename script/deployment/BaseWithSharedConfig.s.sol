...
/**
 * @title BaseWithSharedConfig
 * @dev Abstract base contract for MultipliVault deployment across different networks.
 *      Used for deploying various tokens that share the existing VARIABLE_VAULT_FEE_CONTRACT.
 *      All other configurations are consistent across the deployment scripts defined in the base deployment script (Base.s.sol).
 */

abstract contract BaseWithSharedConfig is Script {
    ...
    address public VARIABLE_VAULT_FEE;
    ...
    VariableVaultFee public existingFeeContract;
    ...
    // just creating this function to override the VARIABLE_VAULT_FEE for local/testnet testcases
    function setVariableVaultFeeContract(address existingContract) public {
        VARIABLE_VAULT_FEE = existingContract;
    }
    ...
    function validateDeploymentConfig() public view {
        ...
        require(VARIABLE_VAULT_FEE != address(0), "VARIABLE_VAULT_FEE cannot be empty");
        ...
        console.log("VARIABLE_VAULT_FEE:", VARIABLE_VAULT_FEE);
    ...
    function run() public {
       ...
       if (!isFromTest) {
        ...
        console.log("Using existing VariableVaultFee contract...", VARIABLE_VAULT_FEE, ASSET);
        existingFeeContract = VariableVaultFee(VARIABLE_VAULT_FEE);
        
        // =============== REGISTER USDC FEE TO FEE CONTRACT  =============
        IVariableVaultFee.AssetFeeConfig memory initialBtcFeeConfig = IVariableVaultFee.AssetFeeConfig({
           depositFee: IVariableVaultFee.FeeConfig({feeType: IVariableVaultFee.FeeType.FLAT, feeAmount: 0}),
            withdrawalFee: IVariableVaultFee.FeeConfig({feeType: IVariableVaultFee.FeeType.PERCENTAGE, feeAmount: 2e14}), // Set withdrawal fee as 0.02%
            ...
            flashRedeemFee: IVariableVaultFee.FeeConfig({feeType: IVariableVaultFee.FeeType.PERCENTAGE, feeAmount: 2e14}), // Set flashRedeem fee as 0.02%
            feeRecipient: OWNER
        });

        existingFeeContract.registerAsset(ASSET, initialBtcFeeConfig);
        ...
        vault.setFeeContract(existingFeeContract);
        ...
        (
          ...
          ) = existingFeeContract.assetFee(ASSET);
        ...
        console.log("VariableVaultFee owner : ", existingFeeContract.owner());
